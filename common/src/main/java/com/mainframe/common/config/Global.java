package com.mainframe.common.config;

import com.mainframe.common.utils.StringUtils;
import com.mainframe.common.utils.YamlUtil;
...
public class Global
{
    ...
    {
        return StringUtils.nvl(getConfig("gen.packageName"), "com.mainframe.project.module");
    }
